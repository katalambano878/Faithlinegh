...
export const metadata: Metadata = pageMetadata({
  ...
  description: `The terms and conditions for shopping with ${SITE_NAME}.`,
  path: '/terms',
});
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-gray-600 mb-6">
              <li className="flex items-start gap-2">
                <i className="ri-close-circle-line text-[#5B4436] mt-1"></i>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              We offer nationwide delivery across Ghana. Contact us for any order issues or product exchanges. See our Returns page for complete details.
            </p>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              All content on this website, including text, graphics, logos, images, videos, and software, is the property of Faithlinegh or its content suppliers and is protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              To the fullest extent permitted by law, Faithlinegh shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from:
            </p>
            <ul className="space-y-2 text-gray-600 mb-6">
              <li className="flex items-start gap-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              You agree to indemnify and hold harmless Faithlinegh, its affiliates, officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from your use of the website, violation of these terms, or infringement of any third-party rights.
            </p>
          </section>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Faithlinegh</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-100 border-2 border-gray-200 p-8 rounded-xl text-center">
