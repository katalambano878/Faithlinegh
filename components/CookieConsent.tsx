...
export default function CookieConsent() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-4 border-brand-brown shadow-2xl z-[9999] animate-slide-up">
          ...
          {!showPreferences ? (
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex items-start space-x-4 flex-1">
                <div className="w-12 h-12 flex items-center justify-center bg-gray-100 rounded-lg flex-shrink-0">
                  <i className="ri-cookie-line text-2xl text-brand-brown"></i>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-brand-brown mb-2">We Value Your Privacy</h3>
                  <p className="text-sm text-gray-600 leading-relaxed mb-3">
                    We use cookies to enhance your browsing experience, serve personalized content, and analyze our traffic. 
                    By clicking "Accept All", you consent to our use of cookies. 
                    <Link href="/privacy" className="text-brand-brown hover:text-brand-tan font-medium ml-1 whitespace-nowrap">
                  ...
                  <label className="flex items-start space-x-2 cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 mt-0.5 text-brand-brown border-gray-300 rounded focus:ring-brand-brown cursor-pointer"
                    />
                    <span className="text-xs text-gray-600 group-hover:text-brand-brown">
                      I agree to the{' '}
                      <Link href="/terms" className="text-brand-brown hover:text-brand-tan font-medium">
                        Terms & Conditions
                      </Link>
                      {' '}and{' '}
                      <Link href="/privacy" className="text-brand-brown hover:text-brand-tan font-medium">
                        Privacy Policy
                      </Link>
                    </span>
                  </label>
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-brand-brown">Cookie Preferences</h3>
                <button
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex-1 pr-4">
                    <div className="flex items-center space-x-2 mb-2">
                      <h4 className="font-semibold text-brand-brown">Necessary Cookies</h4>
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex-1 pr-4">
                    <h4 className="font-semibold text-brand-brown mb-2">Analytics Cookies</h4>
                    <p className="text-sm text-gray-600">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.analytics ? 'bg-brand-brown' : 'bg-gray-300'
                    }`}
                  >
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex-1 pr-4">
                    <h4 className="font-semibold text-brand-brown mb-2">Marketing Cookies</h4>
                    <p className="text-sm text-gray-600">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.marketing ? 'bg-brand-brown' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
                ...
                <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex-1 pr-4">
                    <h4 className="font-semibold text-brand-brown mb-2">Functional Cookies</h4>
                    <p className="text-sm text-gray-600">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors cursor-pointer ${
                      preferences.functional ? 'bg-brand-brown' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
              ...
              <label className="flex items-start space-x-2 cursor-pointer group mb-4">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 text-brand-brown border-gray-300 rounded focus:ring-brand-brown cursor-pointer"
                />
                <span className="text-sm text-gray-600 group-hover:text-brand-brown">
                  I agree to the{' '}
                  <Link href="/terms" className="text-brand-brown hover:text-brand-tan font-medium">
                    Terms & Conditions
                  </Link>
