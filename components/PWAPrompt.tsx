              ...
              <>
                ...
                <div className="flex items-center gap-4 mb-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-brand-brown text-lg truncate">Install Our App</h3>
                ...
                <div className="bg-gray-50 rounded-2xl p-5 mb-5">
                  <p className="text-xs font-semibold text-brand-brown uppercase tracking-wider mb-4">How to install</p>

                  <div className="space-y-4">
                    {/* Step 1 */}
                    <div className={`flex items-start gap-3 transition-opacity ${iosStep === 0 ? 'opacity-100' : 'opacity-50'}`}>
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold ${iosStep === 0 ? 'bg-brand-brown text-white' : 'bg-gray-200 text-gray-500'}`}>
                    ...
                    <div className={`flex items-start gap-3 transition-opacity ${iosStep === 1 ? 'opacity-100' : iosStep < 1 ? 'opacity-40' : 'opacity-50'}`}>
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold ${iosStep === 1 ? 'bg-brand-brown text-white' : iosStep > 1 ? 'bg-gray-200 text-gray-500' : 'bg-gray-100 text-gray-400'}`}>
                    ...
                    <div className={`flex items-start gap-3 transition-opacity ${iosStep === 2 ? 'opacity-100' : 'opacity-40'}`}>
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold ${iosStep === 2 ? 'bg-brand-brown text-white' : 'bg-gray-100 text-gray-400'}`}>
                        3
                      </div>
                      <div className="flex-1">
                  ...
                  {[
                    ...
                    >
                      <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-2">
                        <i className={`${feature.icon} text-brand-brown text-lg`} />
                      </div>
