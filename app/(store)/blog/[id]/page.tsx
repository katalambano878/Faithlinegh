...
const POST_META: Record<string, { title: string; description: string; image: string; date: string }> = {
  '1': {
    title: 'The Ultimate Guide to Online Shopping in Ghana',
    description:
      'Everything you need to know about safe, convenient online shopping in Ghana — payment methods, delivery, and how to spot trustworthy stores.',
  ...
  '2': {
    ...
    description:
      'Discover trending products that elevate your living space and make your home more comfortable and stylish.',
    image: '/placeholder-product.svg',
    date: '2024-12-12',
  },
  '3': {
    ...
    description:
      'Learn the key indicators of quality and how to make informed purchasing decisions that offer the best value for your money.',
    image: '/placeholder-product.svg',
    date: '2024-12-10',
  },
};
...
export async function generateMetadata({
  ...
  const meta = POST_META[id] || POST_META['1'];
  return pageMetadata({
    title: meta.title,
    ...
    keywords: ['fashion blog Ghana', 'shopping tips Ghana'],
  });
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const postMeta = POST_META[id] || POST_META['1'];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center">
                  <i className="ri-user-line text-gray-900 text-xl"></i>
                </div>
                <div>
            ...
            {relatedPosts.map((relatedPost) => (
              ...
              >
                <div className="relative h-48">
                  ...
                  />
                  <span className="absolute top-4 left-4 bg-gray-900 text-white px-3 py-1 rounded-full text-xs font-medium">
        ...
        <div className="mt-16 bg-gradient-to-br from-gray-900 to-gray-900 rounded-2xl p-12 text-center text-white">
          ...
          <form className="max-w-md mx-auto flex gap-3">
            ...
            <button
              type="submit"
              className="bg-white text-gray-900 px-8 py-4 rounded-full font-medium hover:bg-gray-50 transition-colors whitespace-nowrap"
            >
              Subscribe
            </button>
          </form>
