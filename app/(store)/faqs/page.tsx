...
export default function FAQsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Delivery times depend on your location. We offer nationwide delivery across Ghana. Final delivery timelines are shown at checkout and in your order updates.'
    },
    {
      category: 'shipping',
    ...
    },
    {
      ...
      answer: 'We offer nationwide delivery across Ghana.'
    },
    {
      category: 'shipping',
    ...
    },
    {
      ...
      answer: 'Delivery speed depends on your location. We dispatch nationwide across Ghana and share estimated timing during checkout and after order confirmation.'
    },
    {
      category: 'returns',
    ...
    },
    {
      ...
      answer: 'We accept Mobile Money, Visa/Mastercard credit and debit cards, bank transfers, and Cash on Delivery for eligible orders within Accra. All payments are processed securely.'
    },
    {
      category: 'payment',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Link href="/returns" className="bg-gray-50 p-8 rounded-2xl hover:shadow-lg transition-all cursor-pointer">
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn about our nationwide delivery options.
            </p>
          </Link>
