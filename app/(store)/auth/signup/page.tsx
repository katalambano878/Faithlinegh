      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <Link href="/" className="inline-block mb-5">
            <img src="/logo.png" alt="Faithlinegh" className="h-10 mx-auto" />
          </Link>
            ...
            <div>
              <label className="flex items-start space-x-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 mt-1 text-gray-700 rounded focus:ring-gray-600"
                />
                <span className="text-sm text-gray-700">
                  I agree to the{' '}
                  <Link href="/terms" className="text-gray-900 hover:text-gray-900 font-medium whitespace-nowrap">
                    Terms & Conditions
                  </Link>
                  {' '}and{' '}
                  <Link href="/privacy" className="text-gray-900 hover:text-gray-900 font-medium whitespace-nowrap">
                    Privacy Policy
                  </Link>
                </span>
              </label>
