      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="bg-[#FAF3EE]/50 border border-[#C9A24B]/30 p-6 rounded-xl mt-6">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              To exercise any of these rights, please contact us at <a href="mailto:support@faithlinegh.com" className="text-gray-900 font-medium hover:underline">support@faithlinegh.com</a> or through your account settings. We will respond within 30 days.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              Faithlinegh does not knowingly collect personal information from individuals under the age of 18. All purchases and account registrations must be completed by an adult. If you believe data from a minor was submitted in error, contact us and we will remove it promptly.
            </p>
          </section>
